...
<body>
    <h3 class="text-center py-4 m-0" id="cb">Edit Account </h3>
    <form action="" method="post" enctype="multipart/form-data" class="text-center" id="cb">
        ...
        <div class="form-outline mb-4 d-flex w-50 m-auto">
            ...
            <!-- <img src="./user_images/<?php echo $user_image;  ?>" alt="" class="pi"> -->
        </div>
        <div class="form-outline mb-4">
        ...
        <input type="submit" value="update" class="cp mb-3" name="user_update">
    </form>
</body>
